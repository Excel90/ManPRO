...
<div class="container-fluid">
  <div class="row p-4" style="background: #5a47ab; width: 100%; left: 0">
    ...
    <div class="row text-center">
      <div class="col" style="margin-top: 20vh; margin-bottom: 20vh; color: white">
        ...
        <h4>Feeling Lucky Today ?</h4>
      </div>
    </div>
  </div>
  <div class="row p-5" id="view">
    <center>
            ...
            <table class="table table-borderless">
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $fetch['birth_place'] ?></td>
                </tr>
                <tr>
                  <th scope="row">Birthdate</th>
                  <td><?php echo date('d-m-Y', strtotime($fetch['birth_date'])) ?></td>
                </tr>
                <tr>
      ...
      <div class="col-md-3">
        <div class="row m-3">
          <button class="btn btn-primary" style="background: #39229a">
            <span style="padding-left: 2em; padding-right: 2em;" onclick="viewtoedit()">Edit Profile</span>
          </button>
        </div>
        <div class="row m-3">
  ...
  <div class="row p-5 hide " id="edit">
    <center>
      <form action="../Manage/profile.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-3">
          <div class="row m-3">
            <button type="submit" name="upload" id="reg_button" class="btn btn-primary" style="background: #39229a">
              <span style="padding-left: 2em; padding-right: 2em;" onclick="">Confirm</span>
            </button>
          </div>
          <div class="row m-3">
            <button id="reg_button" class="btn btn-primary" style="background: #39229a">
              <span style="padding-left: 2em; padding-right: 2em;" onclick="edittoview()">back</span>
            </button>
          </div>
        </div>
      </form>
...
<script>
  function viewtoedit() {
    var elementedit = document.getElementById("edit");
    var elementview = document.getElementById("view");
    elementview.classList.add("hide");
    elementedit.classList.remove("hide");
  }

  function edittoview() {
    var elementedit = document.getElementById("edit");
    var elementview = document.getElementById("view");
    elementedit.classList.add("hide");
    elementview.classList.remove("hide");
  }
</script>
<script>
