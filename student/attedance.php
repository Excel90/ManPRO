...
<body>
  <div class="container-fluid">
    ...
    <div class="row p-5">
        ...
        <div class="col-sm-7" style="margin: auto;">
          <ul class="nav">
            <li style="margin:auto;">
              <i class="fas fa-circle" style="color:#FBD15B ;"></i>
              <span>Absent</span>
            </li>
            <li style="margin:auto;">
              <i class="fas fa-circle" style="color:#48B08B;"></i>
      ...
      <div class="row" style="margin-bottom: 4em;">
        ...
        <?php while ($fetch2 = $stmt2->fetch()) {
          if ($fetch2['status'] == 1) {
            $show = "done";
          } else if ($fetch2['status'] == 2) {
            $show = "absent";
          }
        ?>
          <div class="col-sm-3 text-center <?php echo $show ?>" style="  width: 10em;height: 10em;margin: auto;border-radius: 10px;">
            <div class="row p-2" style="font-size: 1em;color: #39229a;font-family: 'Open Sans', sans-serif;">
              <span><?php echo $fetch2['date'] ?></span>
              <h1 style="font-size: 3em; margin-top:2px;"><?php echo $fetch2['attendance_n'] ?></h1>
            </div>
            <span style="font-size: 1em;color: #39229a;font-family: 'Open Sans', sans-serif;"><?php echo $fetch2['topic'] ?></span>
          </div>
        <?php } ?>
      </div>
    </div>
    ...
    <div class="row text-center p-5 hide">
      <h1 class="mt-2" style="color: #39229a">Grade</h1>
      <span class="mt-4" style="font-size: 2vw">This is your current grade in this level</span>
