  ...
  <div class="container-fluid">
    ...
    <div class="row text-center p-5">
      <a action="../manage/transaction.php" class="col p-5 btnclass m-4">
        ...
        <div class="payment">
          <?php
          $sql = "SELECT * FROM `course` WHERE id_course = 1 ";
          $stmt = $pdo->prepare($sql);
          $stmt->execute();
          $fetch = $stmt->fetch()
          ?>
        ...
        <form action="../student/classlist.php" Method="POST">
          <button type="submit" name="id_course" value="1" id="reg_button" class="btn btn-primary" style="background: #39229a">
            <span style="padding-left: 2em; padding-right: 2em;">Lihat Class</span>
          </button>
        </form>
      </a>

      <a class="col p-5 btnclass m-4">
        <img src="../asset/advance.jpg" alt="" style="width: 90%; margin: auto; border-radius: 5px" />
        <div class="payment">
          <?php
          $sql = "SELECT * FROM `course` WHERE id_course = 2 ";
          $stmt = $pdo->prepare($sql);
          $stmt->execute();
          $fetch = $stmt->fetch()
          ?>
        ...
        <form action="../student/classlist.php" Method="POST">
          <button type="submit" name="id_course" value="2" id="reg_button" class="btn btn-primary" style="background: #39229a">
            <span style="padding-left: 2em; padding-right: 2em;">Lihat Class</span>
          </button>
        </form>
      </a>
      ...
      <a class="col p-5 btnclass m-4">
        <img src="../asset/pro.jpg" alt="" style="width: 90%; margin: auto; border-radius: 5px" />
        <div class="payment">
          <?php
          $sql = "SELECT * FROM `course` WHERE id_course = 3 ";
          $stmt = $pdo->prepare($sql);
          $stmt->execute();
          $fetch = $stmt->fetch()
          ?>
        ...
        <form action="../student/classlist.php" Method="POST">
          <button type="submit" name="id_course" value="3" id="reg_button" class="btn btn-primary" style="background: #39229a">
            <span style="padding-left: 2em; padding-right: 2em;">Lihat Class</span>
          </button>
        </form>
      </a>
