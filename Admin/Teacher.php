            ...
            <li class="nav-item active">
                ...
                <div id="collapseDatabase" class="collapse show" aria-labelledby="headingDatabase"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Teacher.php">Teacher</a>
            ...
            <div id="content">
                ...
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content" id="teachermodal">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click", ".edit", function(){
            ...
            $.ajax({
                url: "ajax/getmodalteacher.php",
                method: "POST",
                data: {
                    id: data
                },
                success: function (result) {
                    $("#teachermodal").html(result);
                },
                error: function () {
                    alert("Server Not Responding");
                }
        ...
        $(document).on("click", ".create", function(){
            $.ajax({
                url: "ajax/createmodalteacher.php",
                method: "POST",
                data: {
